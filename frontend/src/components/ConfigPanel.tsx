...
export function ConfigPanel() {
  ...
  return (
    <section>
      ...
      <details className="border border-gray-300 dark:border-gray-800 rounded">
        <summary className="cursor-pointer p-2 text-sm text-gray-700 dark:text-gray-300">
          Raw TOML (hash {data.hash.slice(0, 12)}…)
        </summary>
        <pre className="bg-gray-50 dark:bg-black/30 text-xs p-2 overflow-x-auto max-h-96 whitespace-pre-wrap">
          {data.content}
        </pre>
      </details>
    </section>
